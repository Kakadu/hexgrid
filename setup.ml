...
(* OASIS_START *)
(* DO NOT EDIT (digest: f0c0f9f35e10e410bae75dbcd6c934ad) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "helpers";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("tsdl", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "SdlDemo.ml"; });
               Executable
                 ({
                     cs_name = "demo-sdl1";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "SdlDemo1.ml"; });
               Executable
                 ({
                     cs_name = "demoFPS";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "SdlDemoFPS.ml"; });
               Executable
                 ({
                     cs_name = "demoSdlText";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "SdlTextDemo.ml"; })
            ];
          plugins =
     ...
     oasis_digest =
       Some "\127\174\004R\162.\001\134\154\255\213\147\179L\173b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
